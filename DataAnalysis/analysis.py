...
class Analysis:
    ...
    def average_in_year(self, province, to_year, from_year=2010, gender=None):
        years = list(range(from_year, to_year + 1))

        result = self.attendance_in_area(province, years, gender)
    ...
    def best_pass_ratio(self, year, gender=None):
        ...
        best = sorted(pass_by_area, key=pass_by_area.get, reverse=True)[0]
    ...
    def compare_pass_ratio(self, province_1, province_2, gender=None):
        ...
        province_data = self.get_data_by_params(params)
        data_by_years = self.sort_data_by_years(province_data)
        pass_ratio_by_years = {}
